...
//(cmt) if turn == true ===> chance for white
// (cmt)if turn == false ===> chance for black
...
// (cmt)set details to the chess object
...
//(cmnt)find the crossing chessman index from Chssmans divs id aray
...
// (cmnt)add cross chessmans to cross queue
